...
<?php
	...
	*/
	...
	// runs code in the if block when the superglobal $_POST[] holds the contents of the form sent in: in this case frmAddPlayer 
	if(isset($_POST['frmAddPlayer']))
	{
		...
		$sqlStatement="INSERT INTO contact (username, firstName, lastName, email) VALUES ('$_POST[username]','$_POST[firstName]','$_POST[lastName]','$_POST[email]')";
